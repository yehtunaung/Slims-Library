        ...
        <form class="modal-content" action="index.php" method="get">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="adv-subject"><?=__('Call Number');?></label>
                            <input type="text" name="callnumber" class="form-control" id="adv-callnumber"
                                   placeholder="<?=__('Enter call number'); ?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="adv-series_title"><?=__('Series Title');?></label>
                            <input type="text" name="series_title" class="form-control" id="adv-series_title"
                                   placeholder="<?=__('Enter Series Title'); ?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="adv-publisher"><?=__('Publisher');?></label>
