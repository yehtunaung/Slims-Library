...
<head>
    ...
    <?php /* <meta name="generator" content="<?php echo SENAYAN_VERSION ?>"> /.hw */?>
    ...
    <!-- // My custom style -->
    <link rel="stylesheet" href="<?php echo assets('css/custom.css?v=' . date('Ymd-his')); ?>">
