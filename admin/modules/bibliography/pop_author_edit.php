...
if(!isset($_GET['authority_level'])){
    ...
    $query = 'SELECT b.biblio_id,ba.author_id,b.title,ma.author_prefix,ma.author_name,ma.authority_type,ba.* FROM biblio b LEFT JOIN biblio_author ba ON ba.biblio_id=ba.biblio_id
    ...
    // author prefix
    $form->addAnything(__('Author Prefix'),  $rec_d['author_prefix']);
    // author name
